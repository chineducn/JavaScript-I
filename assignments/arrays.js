...
// let identifyCar = carID => {
//   console.log(`Car ${carID} is a ${inventory[carID - 1].car_year} ${inventory[carID - 1].car_make} ${inventory[carID - 1].car_model}`);
// }
// identifyCar(33);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = () => `The last car in the inventory is the ${inventory[inventory.length - 1].car_make} ${inventory[inventory.length - 1].car_model}`;
// console.log(lastCar());
